...
<aside id="separator-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   ...
   <a href="/" className="flex items-center ps-2.5 mb-5">
         <i className=" me-2  text-blue-700 text-2xl fa-solid fa-book-open"></i>
         <span className="self-center text-2xl font-semibold whitespace-nowrap text-blue-700">Book Bound</span>
      </a>
      <ul className="space-y-2 font-medium">
         <li>
            <a href="/admin/dashboard" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-blue-500 group">
               <svg className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
         ...
         <li>
            <a href="/admin/dashboard/upload" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-blue-500 group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">Upload Books</span>
            </a>
         </li>
         <li>
            <a href="/admin/dashboard/manage" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-blue-500 group">
         ...
         {/* <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-blue-500 group">
         ...
         <li>
            <a href="/login" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-blue-500 group">
         ...
         <li>
            <a onClick={confirmLogout} className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-blue-500 group">
               <svg className="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
