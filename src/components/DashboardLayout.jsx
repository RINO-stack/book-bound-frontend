...
const DashboardLayout = () => {
  ...
  return (
    ...
    <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
      <div className="flex items-center p-8 bg-white shadow rounded-lg my-8">
      ...
      <div className="flex items-center p-8 bg-white shadow rounded-lg my-8">
        ...
        <div>
          <span className="block text-2xl font-bold">17</span>
      ...
      <div className="flex items-center p-8 bg-white shadow rounded-lg my-8">
        ...
        <div>
          <span className="inline-block text-2xl font-bold">$234</span>
    ...
    <section className="grid md:grid-cols-2 xl:grid-cols-3 xl:grid-rows-3 xl:grid-flow-col gap-6">
        ...
        <div className="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            ...
            <span className="block text-gray-500">Website visits (last week)</span>
          </div>
        </div>
        <div className="row-span-3 bg-white shadow rounded-lg">
          ...
          <div className="overflow-y-auto" style={{ maxHeight: '24rem' }}>
            <ul className="p-6 space-y-6">
                ...
                <span className="text-gray-600">Jamie Mclaren</span>
              </li>
              <li className="flex items-center">
                <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
